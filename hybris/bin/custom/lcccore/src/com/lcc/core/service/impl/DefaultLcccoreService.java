...
public class DefaultLcccoreService implements LcccoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultLcccoreService.class);
	...
	{
		return DefaultLcccoreService.class.getResourceAsStream("/lcccore/sap-hybris-platform.png");
	}
