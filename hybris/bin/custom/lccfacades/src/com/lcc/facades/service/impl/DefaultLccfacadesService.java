 ...
 */
package com.lcc.facades.service.impl;
...
public class DefaultLccfacadesService implements LccfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultLccfacadesService.class);
	...
	{
		return DefaultLccfacadesService.class.getResourceAsStream("/lccfacades/sap-hybris-platform.png");
	}
